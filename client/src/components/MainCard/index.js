...
const MainCard = (props) => {
  ...
  return (
    <div>
        <section className="card" id="mainCard">
          <Container fluid>
            <Hero />
          </Container>
          <Container>
            <Row>
              <Col size="12">
                <div className="tLocations">
                  <i class="fas fa-map-marker-alt"><span className="pl-3">Dates by Location</span></i>
                </div>
                <Row>
                  {tag.map(place => (
                        <div key={place.id} >
          ...
          <Row>
              <Col size="12">
                <div className="byCategory">
                  <i class="fas fa-map-marker-alt"><span className="pl-3">Dates by Category</span></i>
                </div>
                <Row>
              ...
              <Col size="12">
                <div className="byCategory">
                  <i class="fas fa-map-marker-alt"><span className="pl-3">Dates by Occasion</span></i>
                </div>
                <Row>
                  {occasion.map(occ => (
                        <div key={occ.id} >
